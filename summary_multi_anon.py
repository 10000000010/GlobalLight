...
def parse_args():
    ...
    parser.add_argument("--memo", type=str, default='0418_afternoon_Roma_10_10_bi') #'Fixedtime','MaxPressure'
...
def summary_detail_test(memo, total_summary):
    ...
    for traffic_file in os.listdir(records_dir):
        ...
        result.to_csv(os.path.join(result_dir, "Colight.csv"))
        ...
        # print(os.path.join(result_dir, "Colight.csv"))
...
def summary_detail_baseline(memo):
    ...
    for traffic_file in os.listdir(records_dir):
        ...
        if os.path.getsize(os.path.join(train_dir, "inter_0.pkl")) > 0:
            ...
            ave_duration_all = flow_df['duration'].mean()  #travel_time
