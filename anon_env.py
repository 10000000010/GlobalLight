...
class AnonEnv:
    ...
    def reset(self):
        ...
        with open(os.path.join(self.path_to_work_directory,"config.json"), "w") as json_file:
            json.dump(cityflow_config, json_file)
        self.eng = engine.Engine(config_file = os.path.join(self.path_to_work_directory,"config.json"), thread_num=1)
        # self.load_roadnet()
        # self.load_flow()
