...
def parse_args():
    ...
    parser.add_argument("--memo", type=str, default='08_10_afternoon_Fixedtime_10_10_bi')#02_09_afternoon_Fixedtime_3_3_bi
    ...
    parser.add_argument("--road_net", type=str, default='10_10')
    parser.add_argument("--volume", type=str, default='300')#'300',jinan
    parser.add_argument("--ratio", type=str, default='0.3_bi')#'0.3_uni',real
    parser.add_argument("--model", type=str, default="Fixedtime")#'SlidingFormula','Fixedtime','MaxPressure'
...
"""
time log for 3600s
Fixedtime: #uni: 95.82 seconds, 1.60 minutes ;bi: 117.78 seconds, 1.96 minutes
MaxPressure: #uni:89.73 seconds, 1.50 minutes bi: 113.72 seconds, 1.90 minutes
"""